...
void save (int gridDim,char gameArray[][gridDim*2-1],int movesArray[][3],int scoreP1, int scoreP2,int gamemode,char playernum){
    //taking the game mode
    savedgame.gamemode=gamemode;
    //the player who saved the game
    savedgame.turn=playernum;
    //grid and moves info
