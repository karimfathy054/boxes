...
void humanTurn(int gridDim, char gameArray[][gridDim*2-1], int movesArray[][MOVES_ARRAY_WIDTH], player *playerPointers[2], player *players,int *boxCount){
...
void gameLoopVScom(int gridDim, char gameArray[][gridDim*2-1], int movesArray[][MOVES_ARRAY_WIDTH]){
    ...
    while(1){
        ...
        //if joining is successful, save the move
        if(players[0].num==1){
            humanTurn(gridDim, gameArray, movesArray, playerPointers, players, &boxCount);
        }else{
